	...
	<view class="content">
		...
		<view class="transfer-payment">
			<view class="transfer-payment-pic"
				style="background: url(/static/assets/blue-bgi.png) no-repeat;background-size: cover;overflow: hidden;height: 238rpx;border-bottom-left-radius: 20rpx;border-bottom-right-radius: 20rpx">
				<view class="transfer-payment-type">BSC-1</view>
				<view class="transfer-payment-money">
					<view class="transfer-payment-amount">
						<view class="">
							3.1492 <text>FIL</text>
						</view>
